...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Bulan Mei 2025 pada 10.01
...
(9858752, 'Teknik Informatika', 'teknik informatika mempelajari mengenai perangkat lunak');
...
(4, '09876537', 'Rahmawati Putri', 'M.kom', 'Dr.', 'P', 'Jakarta', '1988-05-18', 'Bogor', 'Rahmawati@gmail.com', 2025, 6);
...
(9858751, '2025-05-08', '2025-05-31', 'Jakarta', 'dosen penelitian', 9858752);
...
(9858751, 'perancangan aplikasi presensi', '2025-05-08', '2025-05-30', '2025', 9858752);
...
(6, '20', 'Teknik Informatika', 'Bogor', '0998763829', 'Bu sinta');
...
--
ALTER TABLE `bidang_ilmu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9858753;
...
--
ALTER TABLE `kegiatan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9858752;
